...
<body>
    <header>
        ...
        <address>
            <p>GRAND SINDHU,</p>
            <p>Kidwaipet,<br>Mahbubnagar,<br>Telangana.</p>
            <p>+91 85422 22226</p>
        </address>
        <span><img alt="" src="assets/img/S1.gif"></span>
    </header>
    <article>
        <h1></h1>
        <address>
        ...
        <table>
            <tr> 
                ...
                <td>Customer email: <a href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a> </td>
            </tr>
            <tr> 
    ...
    <aside>
        ...
        <div>
            <p align="center">Email: info@grandSindhu.com || Web: www.grandSindhu.com || Phone: +91 85422 22226 </p>
        </div>
    </aside>
</body>
</html>
