            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <?php
                        ...
                        {
                            $id = $row['type'];
                            $status = ($row['place'] == 'Free') ? 'Available' : 'Booked';
                            $colorClass = ($status == 'Available') ? 'bg-color-green' : 'bg-color-red';

                            echo "<div class='col-md-3 col-sm-12 col-xs-12'>
                                    <div class='panel panel-primary text-center no-boder $colorClass'>
                                        <div class='panel-body'>
                                            <i class='fa fa-users fa-5x'></i>
                                            <h3>{$row['bedding']}</h3>
                                        </div>
                                        <div class='panel-footer back-footer-{$colorClass}'>
                                            {$row['type']} - $status
                                        </div>
                                    </div>
                                </div>";
